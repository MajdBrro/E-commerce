...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('admin.maincategories.store')}}">
        @csrf
        @method('PATCH')
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Title <span class="text-danger">*</span></label>
          <input id="inputTitle" type="text" name="name" placeholder="Enter title"  value="" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='parent_id' id='is_parent' value= ""> Yes
        </div>
        {{-- {{$parent_cats}} --}}
        {{-- {{$category}} --}}
